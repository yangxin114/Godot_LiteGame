...
using System.IO;
using Logs;
public partial class AutoLoadStart : Node
{
	public override void _Ready()
	{
		...
		if (Scenes.SceneManager.Instance == null)
		{
			...
			GetTree().Root.CallDeferred("add_child", sm);
		}
    ...
    var userPath = ProjectSettings.GlobalizePath("user://"); // 修改为 GlobalizePath
